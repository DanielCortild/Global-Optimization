...
postprocessor001 = GO.PostProcessor(samples_filename001)
...
postprocessor01 = GO.PostProcessor(samples_filename01)
...
postprocessor1 = GO.PostProcessor(samples_filename1)
