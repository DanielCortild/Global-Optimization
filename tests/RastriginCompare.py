...
title = "Rastrigin OLA"
algorithm = HRLA.AlgorithmOLA(d=d, M=100, N=10, K=14000, h=0.01, title=title, U=U, dU=dU, initial=initial)
samples_filename_OLA = algorithm.generate_samples(As=[1,2,3,4], sim_annealing=False)
postprocessor = HRLA.PostProcessor(samples_filename_OLA)
postprocessor.plot_empirical_probabilities(dpi=100, layout="22", tols=[1,2,3,4], running=False)
